...
function CloudAPI(httpProtocol) {
    ...
    this.liveMusicPlaylistDetailListUrl     = 'api/playlist/detail/list/';
...
CloudAPI.prototype.liveMusicPlaylistDetailList = function(json) {
    return this.http.get(this.baseUrl + this.liveMusicPlaylistDetailListUrl + json.playlist_id + "/" + json.uuid);
};
